...
export default function Home() {
  ...
  return (
    <div className="space-y-12 animate-fade-in">
      {/* Navigation Bar */}
      <nav className="bg-[#1a237e] text-white shadow-lg fixed top-0 left-0 right-0 z-50">
        {/* Upper bar with NITJ Alumni Cell text */}
        <div className="bg-[#0d1453] py-1">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-sm text-center font-medium">NITJ Alumni Cell</p>
          </div>
        </div>
